...
def process():
    if request.method == 'POST':
        ...
        process = subprocess.Popen(['python', '102117150.py', singer_name, str(num_videos), str(duration_to_cut), 'output.mp3'])
        ...
        msg['From'] = 'kkashish_be21@thapar.edu'  
        msg['To'] = email
        ...
        with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
            smtp.login('kkashish_be21@thapar.edu', 'ctep mqlf ogmg fiaj')  
